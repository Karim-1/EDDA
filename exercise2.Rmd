...
par(mfrow=c(2,2))
hist(telephone_data$Bills, prob=TRUE, xlab = "First month bills (€)", main = "data before correction")
hist(corrected_telephone_data, prob=TRUE, xlab = "First month bills (€)", main = "data after correction")
