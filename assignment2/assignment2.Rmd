...
We prefer the model of the step up method, because it uses two more variables instead of two for a slightly lower R^2 value.
...
After removal of the outliers, the qq-plot shows a linear line.
Shapiro-Wilk test results in a p-value of 0.03.
