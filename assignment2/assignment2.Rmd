...
anova(studentslm)
```
A two-way anova gives us a p value for interface of 0.013 this is below the threshold of 0.05 and thus is the interface significant. This means that the search time is not the same for all interfaces.
