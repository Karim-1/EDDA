...
We once again use the bootstrapping method to sample from the dataset. The mean of the samples is retrieved and next, 
...
If we plot the means of the samples, we get:
```{r}
hist(Tstar, prob=T)
```
